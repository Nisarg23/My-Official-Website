...
// &APPID=eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzUxMiIsImtpZCI6IjI4YTMxOGY3LTAwMDAtYTFlYi03ZmExLTJjNzQzM2M2Y2NhNSJ9

// function rank(){
//     const url = "https://api.clashroyale.com/v1/locations/57000047/rankings/players";
// fetch(url, {
//   method: "GET",
//   headers: {
...
// xhr.open('GET', 'https://cors-anywhere.herokuapp.com/https://api.clashroyale.com/v1/locations/57000047/rankings/players');
...
// window.addEventListener("load", function() {
//     const myRequest = new Request('https://api.clashroyale.com/v1/locations/57000047/rankings/players', {
//         method: 'GET',
//         headers:{
